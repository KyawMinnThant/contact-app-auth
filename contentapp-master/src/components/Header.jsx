...
const Header = () => {
  ...
  return (
    <>
      <div className="px-3 py-3 shadow-md flex items-center">
        <button
          className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
          type="button"
          data-drawer-target={token ? "drawer-navigation" : null}
          data-drawer-show={token ? "drawer-navigation" : null}
          aria-controls={token ? "drawer-navigation" : null}
        >
          <HiMenuAlt2 />
        </button>
